...
<!-- Builder -->
     <div class="footer">
          <div class="row justify-content-between align-items-center">
            <div class="col">
              <p class="fs-6 mb-0">&copy; CodeColab <span class="d-none d-sm-inline-block">2025 </span></p>
            </div>
            <!-- End Col -->
              ...
              <div class="d-flex justify-content-end">
                ...
                <ul class="list-inline list-separator">
                  <li class="list-inline-item">
                    <a class="list-separator-link Disable" href="#">FAQ</a>
                  </li>

                  <li class="list-inline-item">
                    <a class="list-separator-link Disable" href="#">License</a>
                  </li>
